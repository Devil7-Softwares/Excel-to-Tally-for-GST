...
#Region "Properties/Fields"
        ...
        ReadOnly Property RegexInvoiceNo As String
            Get
                Dim R As Integer = -1
                Try
                    R = CInt((New System.Text.RegularExpressions.Regex(Utils.Settings.Load.InvoiceNoRegex)).Match(InvoiceNo).Groups("invoice").Value)
...
ByVal ExemptedValue As Double, ByVal Discount As Double, ByVal PlaceOfSupply As State, ByVal CustomSalesLedger As String)
            Me.Party = Party
