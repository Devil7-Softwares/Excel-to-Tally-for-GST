...
#Region "Private Subs & Functions"
        ...
        Private Function ReadLedger(ByVal LedgerData As String, ByRef Parties As List(Of Objects.Party)) As String()
            ...
            For i As Integer = 0 To elements.Count - 1
                ...
                ElseIf elements(i).Name = "SALESTAXNUMBER" AndAlso Utils.Settings.Load.TallyOldVersion Then
                    PartyGSTIN = elements(i).InnerXml
...
#End Region
    ...
    Public Async Function LoadAllMasters() As Threading.Tasks.Task(Of Boolean)
        Try
